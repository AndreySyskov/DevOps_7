...
##  Задание
В папке **src** находится код микрсервисного приложения, написанного на java. Необходимо, использую различные технологии, собрать и развернуть это приложение и проверить его работу при помощью программы Postman. Описание приожения находися в папке **matirials**.

## Part 1. Запуск нескольких docker-контейнеров с использованием docker compose
В первой части необходимо использовать docker и docker-compose для развертывания приложения.
